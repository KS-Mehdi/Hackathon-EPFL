        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="https://minaprotocol.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Mina Protocol</a></li>
              <li><a href="https://hedera.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Hedera Hashgraph</a></li>
              <li><a href="https://hyle.io" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Hylé Infrastructure</a></li>
              <li><a href="https://minaprotocol.com/zk-snarks" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Zero-Knowledge Proofs</a></li>
            </ul>
          </div>
          <div>
